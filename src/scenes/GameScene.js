...
class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.walls.create(600, 700, 'wall');
        ...
        this.bird.body.velocity.setTo(200, 0);
        ...
        this.physics.world.on('collide', (...args) => {
            console.log('collide', args);
        });
        this.physics.world.on('worldbounds', (...args) => {
            console.log('worldbounds', args);
        });
    ...
    //         if (
    //             this.mario.y > 240 ||
    //             this.attractMode.recording.length <=
    //                 this.attractMode.current + 2 ||
    ...
    //         }
    //         if (
    //             this.attractMode.time >=
    //             this.attractMode.recording[this.attractMode.current + 1].time
    //         ) {
    //             this.attractMode.current++;
    //             this.mario.x = this.attractMode.recording[
    //                 this.attractMode.current
    //             ].x;
    //             this.mario.y = this.attractMode.recording[
    //                 this.attractMode.current
    //             ].y;
    ...
    //         this.keys = {
    //             jump: {
    //                 isDown: this.attractMode.recording[this.attractMode.current]
    //                     .keys.jump,
    //             },
    //             jump2: {
    //                 isDown: false,
    ...
    //     if (
    //         this.levelTimer.time - this.levelTimer.displayedTime * 1000 <
    //         1000
    //     ) {
    //         this.levelTimer.displayedTime = Math.round(
    //             this.levelTimer.time / 1000,
    //         );
    ...
    //         if (
    //             sprite.bending &&
    //             tile.properties.pipe &&
    //             tile.properties.dest
    //         ) {
    ...
    //                         this.groundLayer,
    //                     );
    //                     // sprite.scene.sound.playAudioSprite(
    //                     //     'sfx',
    //                     //     'smb_breakblock',
    //                     // );
    //                     sprite.scene.blockEmitter.emitParticle(
    //                         6,
    //                         tile.x * 16,
    //                         tile.y * 16,
    //                     );
    ...
    update(time, delta) {
        ...
        this.score.text.setText(`${this.score.pts++}`);
    }
    ...
    //                 console.error(
    //                     'Unknown:',
    //                     this.tileset.tileProperties[enemy.gid - 1],
